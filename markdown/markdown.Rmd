...
```{r plot, echo = FALSE, message = F, warning = F, fig.width = 7.5, fig.height = 4, fig.cap = "\\label{fig:coef-plot}Estimated Depressive Effect of Living in MKE, 2020 Primary", fig.pos = "H", fig.align = "center"}
